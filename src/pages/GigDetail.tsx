                        ...
                        {gig.requires_skill_test && (
                            <>
                                ...
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        This gig requires a skill test. {isEmployer
                                            ? 'As an employer, you are exempt from taking the skill test.'
                                            : 'You must complete and pass the skill test before applying.'}
                                    </AlertDescription>
                                </Alert>
                            </>
                        )}
