...
import { CheckCircle, AlertTriangle, MapPin, Clock, Filter, Loader2, PlusCircle, Award } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { PageHeader } from "@/components/layout/PageHeader";
import { getJobs, type Assignment } from "@/lib/api/assignments";
import { useToast } from "@/hooks/use-toast";
import { useSupabase } from "@/providers/SupabaseProvider";
import { SkillCategory, SKILL_DISPLAY_NAMES } from "@/types/assignments";
...
const Jobs = () => {
  ...
  useEffect(() => {
    ...
    fetchAssignments();
  }, [locationFilter, categoryFilter, toast]);
  ...
  const filteredJobs = assignments.filter(job => {
    ...
    return matchesLocation && matchesCategory && matchesSafety;
  });
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          ...
          <Select value={categoryFilter} onValueChange={setCategoryFilter}>
            <SelectTrigger className="sm:w-56 h-11">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        {job.category && (
                          <Badge variant="secondary" className="flex items-center gap-1">
                            ...
                            {SKILL_DISPLAY_NAMES[job.category as SkillCategory]}
                          </Badge>
                        )}
                        {job.urgent && (
