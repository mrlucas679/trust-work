...
- **Skill Tests System:**
  - `SKILL_TESTS_IMPLEMENTATION.md` — Complete implementation report with architecture, components, and deployment guide
  - `SKILL_TESTS_QUICKSTART.md` — Quick reference for developers and users
  - `ASSIGNMENT_SYSTEM.md` — Related legacy assignment/certification system
