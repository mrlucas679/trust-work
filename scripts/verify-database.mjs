...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNvamppenFhaGdwaHliZGlqcWFqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE0MjMyOTksImV4cCI6MjA3Njk5OTI5OX0.WAcN8WVvs1_hTb6zW7IDS95GeBI-U6LbfL1ErQb74ng';
...
async function verifyTables() {
    ...
    if (results.failed.length > 0) {
        ...
        console.log('   1. Open: https://app.supabase.com/project/sojjizqahgphybdijqaj/editor');
        console.log('   2. Click "SQL Editor" → "New Query"');
        console.log('   3. Open file: supabase/schema.sql');
        console.log('   4. Copy ALL contents and paste in SQL Editor');
        console.log('   5. Click "Run" to execute');
        console.log('   6. Wait 30 seconds, then refresh your app');
        process.exit(1);
    } else {
        console.log('\n✅ All tables are accessible! Database is ready.');
        process.exit(0);
    }
}
